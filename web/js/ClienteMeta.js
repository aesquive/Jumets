...
var ClienteMeta = {
	...
	*/
    ...
    ObtenerIdRdgTC :function(){
        return ClienteMeta.obtenerId('rdgTC')
    },
	
	
    ObtenerIdMesVencido:function(){
        return ClienteMeta.obtenerId('mesVencido')
    },
		
    ObtenerIdPcuso:function(){
        return ClienteMeta.obtenerId('pcuso')
    },
		
    ObtenerIdPcPago:function(){
        return ClienteMeta.obtenerId('pcPago')
    },
		
	
    //Problema BC 
    ObtenerIdRdgProblemaB:function(){
        return ClienteMeta.obtenerId('rdgProblemaB')
    },

    ObtenerIdBuroAct: function(){
        return ClienteMeta.obtenerId('buroAct')
        },
	
    ObtenerIdBuroUso:function(){
        return ClienteMeta.obtenerId('buroUso')
        },
	
    ObtenerIdBuroHist:function(){
        return ClienteMeta.obtenerId('buroHist')
        },
	
    ObtenerIdBuroPago:function(){
        return ClienteMeta.obtenerId('buroPago')
        },
	
    ObtenerIdBuroAnt:function(){
        return ClienteMeta.obtenerId('buroAnt')
        },	
