...
<title>Comportamiento y Gesti&oacute;n </title>
<!-- InstanceEndEditable -->
  ...
  <div id="encabezado">
	...
	<table width="321" border="0" valign="right" cellpadding="0" cellspacing="0" class="whiteSubtitle">
       ...
       <tr>
         ...
         <td width="10">&nbsp;</td>
         <td width="42"><a href="../index_autent.jsp" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('exit','','../images/acceso/activos_exit.png',1)"><img src="../images/acceso/inactivos_exit.png" name="exit" width="33" height="33" border="0" class="blueText" id="exit" /></a><a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('calc','','../images/acceso/activo-calc.png',1)"></a></td>
       </tr>
       <tr>
