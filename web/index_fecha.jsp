...
<body onload="MM_preloadImages('images/activo_meta.png','images/activo_cliente.png','images/activo_riesgo.png','images/activo_comportamiento.png','images/activo_deuda.png','images/activo_utileria.png','images/activo_salir.png','images/activo_entrar.png','images/wizar_activo.png','images/activo_aceptar.png','images/activo_cancelar.png')">
<center>
<div id="contenedor">
  <div id="encabezado">
    <div id="borde_iz"></div>
  ...
  <tr>
    <td height="32" class="whiteTitle" align="left">Verifique la Fecha del D&iacute;a de Hoy : </td>
    </tr>
  <tr>
    <td align="left" valign="bottom"><form id="form1" name="form1" method="post" action="">
	<input name="user" type="text" class="blackText2" id="user" />
	<a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('entrar','','images/activo_entrar.png',1)"></a>
    <a href="index_autent.html" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('aceptar','','images/activo_aceptar.png',1)"><img src="images/inactivo_aceptar.png" name="aceptar" width="66" height="22" border="0" align="absbottom" id="aceptar" /></a>
    <a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('cancelar','','images/activo_cancelar.png',1)"><img src="images/inactivo_cancelar.png" name="cancelar" width="66" height="22" border="0" align="absbottom" id="cancelar" /></a>
    </form>
    </td>
    </tr>
</table>
