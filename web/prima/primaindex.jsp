...
<%@page import="java.io.IOException"%><html
    ...
    <head>
        ...
        <script>
            function buscarTodosPrima(){
                document.getElementById('command').value = "BuscarT";
                document.getElementById('PrimaIndex').submit();	
            }
            
            function buscarPrima(){
                if( document.getElementById('cPersona').checked == false){
                    ...
                    if(document.getElementById('cPersona').checked == true){
                        if(document.getElementById('persona').value==""){
                            valida = 1;
                            msg = msg + "Capture a una Persona como criterio de busqueda." + "\n";
                        }
                    }
                            ...
                            <p><%@include file="../ErrorTag.jsp"%>
                                <table width="888" border="0" align="center" cellpadding="0"
                                    ...
                                    <tr>
                                        ...
                                        <td align="" valign="top">
                                            <div align="center"><a onclick="buscarPrima()" onmouseout="MM_swapImgRestore()"
