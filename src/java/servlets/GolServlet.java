...
public class GolServlet extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request,
		...
		try {
			...
			if (command.equalsIgnoreCase("Agregar")) {
				...
				getpagina7(request);
				GolBean gol = (GolBean) request.getSession()
						.getAttribute("gol");
				...
				String lista = GolSql.getListaGol(rfc, nombre, 1);
	...
	public static void getpagina1(HttpServletRequest request) {
		...
		gol.setComercioIndispensable(request
				.getParameter("comercioIndispensable"));
	...
	public static void getpagina2(HttpServletRequest request) {
		...
		gol.setDescripcionOcupacion(request
		...
		gol.setTiempoViviendo(Integer.parseInt(request
				.getParameter("tiempoViviendo")));
	...
	public static void getpagina3(HttpServletRequest request) {
		...
		gol.setConyuge(Integer
				.parseInt((request.getParameter("conyuge") == null || "null"
						.equals(request.getParameter("conyuge"))) ? "0"
						: request.getParameter("conyuge")));
		gol.setHijos(Integer
				.parseInt((request.getParameter("hijos") == null || "null"
						.equals(request.getParameter("hijos"))) ? "0" : request
						.getParameter("hijos")));
		gol.setPadres(Integer
				.parseInt((request.getParameter("padres") == null || "null"
						.equals(request.getParameter("padres"))) ? "0"
						: request.getParameter("padres")));
		gol.setOtros(Integer
				.parseInt((request.getParameter("otros") == null || "null"
						.equals(request.getParameter("otros"))) ? "0" : request
						.getParameter("otros")));
	...
	public static void getpagina7(HttpServletRequest request) {
		GolBean gol = (GolBean) request.getSession().getAttribute("gol");
		gol.setBuroCredito(Integer
				.parseInt(request.getParameter("buroCredito")));
		if (gol.getBuroCredito() == 1) {
